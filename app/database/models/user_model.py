...
class UserModel(BaseModel):
    ...
    supermanaged_organizations = relationship(
        'OrganizationModel', foreign_keys='OrganizationModel.super_manager_id', back_populates='super_manager')

    managed_organizations = relationship(
        'OrganizationModel', foreign_keys='OrganizationModel.manager_id', back_populates='manager')
