...
class UserRequest(UserSchema):
    ...
    def transform_vehicle_id(cls, value):
        if value == '':
            return None
        return value

    @validator('branch_id', pre=True)
    def transform_branch_id(cls, value):
        if value == '':
            return None
        return value
...
class UserResponse(UserSchema):
    ...
    supermanaged_organizations: List[OrganizationResponse] | None = None
    managed_organizations: List[OrganizationResponse] | None = None
